...
$string['groupinvite'] = 'Пожалуйста присоединяйтесь к нашему новостному каналу, чтобы быть в курсе новостей и событий 👉 <a href="{$a->link}">{$a->title}</a>';
$string['groupinvitedone'] = 'Вы были добавлены в наш новостной канал <a href="{$a->link}">{$a->title}</a>';
