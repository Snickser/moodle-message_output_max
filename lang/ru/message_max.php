...
$string['connectme'] = '<br><p style="color: blue;"><b>> Подключить свой аккаунт к MAX <</b></p>';
...
$string['setupinstructions'] = 'Создайте новый бот MAX, используя Botfather. Перейдите по ссылке Botfather ниже и откройте MAX.
Используйте команду "/newbot" в MAX для начала создания бота. Вам надо будет задать название бота, например "{$a->name}" и уникальное имя бота, например "{$a->username}". Полное описание <a href="https://docs.moodle.org/33/en/MAX_message_processor" target="_blank">читаем здесь</a>.';
